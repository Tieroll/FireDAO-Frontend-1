...
const OgPoolAdmin = (props) => {
    ...
    const getMaxEightAdmin = async () => {
        let res = await handleViewMethod("maxLevels", [8])
        setMaxEightAdmin(res)
    }
    const getMaxNineAdmin = async () => {
        let res = await handleViewMethod("maxLevels", [9])
        setMaxNineAdmin(res)
    }
    ...
    const setAdminLevelEightMax = async () => {
        await handleDealMethod("setAdminForMAX", [8, (form2.getFieldValue().maxEight)])
        getMaxEightAdmin()
    }
    const setAdminLevelNineMax = async () => {
        await handleDealMethod("setAdminForMAX", [9, (form2.getFieldValue().maxNine)])
        getMaxNineAdmin()
    }
                ...
                <div>
                    <div className="panel-box">
                        ...
                        <div className="panel-container">
                            ...
                            <div className="panel-title">
                                Lv-8 Administrator Amounts(<span>{maxEightAdmin} </span>)
                            </div>
                            <Form form={form2} name="control-hooks" className="form">
                                <Form.Item
                                    name="maxEight"
                            ...
                            <div className="panel-title">
                                <p>Lv-9 Administrator Super account amounts</p> <span>{maxNineAdmin} </span>
                            </div>
                            <Form form={form2} name="control-hooks" className="form">
                                <Form.Item
                                    name="maxNine"
