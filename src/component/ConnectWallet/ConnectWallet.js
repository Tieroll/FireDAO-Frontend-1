...
const ConnectWallet = (props) => {
    ...
    const items = [
        ...
        },
        {
            label: <div style={{
                ...
                <img style={{width: '20px', height: '15px', marginTop: '23px', marginLeft: '20px', display: 'none'}}
                     src={right}/>
            </div>
            // key: '1',
        },
        {
            label: <div style={{
                ...
                <img style={{width: '20px', height: '15px', display: 'none', marginTop: '23px', marginLeft: '20px'}}
                     src={right}/>
            </div>
            // key: '0',
        },
        ...
        },
        {
            ...
            label:
                <div><img src={ethereum} style={{width: "25px", margin: '0px 10px 5px 0px'}}/><span
                    style={{fontSize: '15px'}}>ETH</span><span style={{float: 'right'}}></span></div>

        },
        {
            label: <div><img src={usdt} style={{width: "25px", margin: '0px 10px 5px 0px'}}/><span
                style={{fontSize: '15px'}}>USDT</span><span style={{float: 'right'}}></span></div>
        }
    ...
    return (
        <ConnectWalletStyle>
            ...
            {isShowWallet && <ConnectWt updateData={() => {
            }} closeDialog={() => {
                setShowWallet(false)
            }}/>}
            {
